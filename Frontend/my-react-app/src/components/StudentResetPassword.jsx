...
function StudentResetPassword({ setPage, token }) {
      ...
      <div className="login-left">
        ...
        <div className="intro-section">
          ...
          <p className="intro-text">
            Secure your student account by setting a new password.
          </p>
        </div>
      ...
      <div className="login-right">
        <div className="auth-card">
          <div className="card-header">
            ...
            <p className="card-subtitle">Student Account Reset</p>
          </div>
          ...
          {success ? (
            <div style={{ textAlign: "center", padding: "24px 0" }}>
              ...
              <button className="login-submit-btn" onClick={() => setPage("student-login")}>
                Go to Student Login
              </button>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="login-form">
              ...
              <button type="submit" className="login-submit-btn" disabled={isLoading}>
                {isLoading ? <div className="loading-spinner"></div> : (
                  <><FaLock className="btn-icon" /><span>Reset Password</span></>
                )}
              </button>
            </form>
          )}
          ...
          <div className="signup-prompt">
            <a href="#" onClick={(e) => { e.preventDefault(); setPage("student-login"); }}>
