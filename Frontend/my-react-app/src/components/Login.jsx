...
function Login({ setPage }) {
  ...
  const handleLogin = async (e) => {
    ...
    const t1 = setTimeout(() => setLoadingMsg("Connecting to server..."), 2500);
    const t2 = setTimeout(() => setLoadingMsg("Waking up server, please wait..."), 6000);
          ...
          <div className="card-header">
            <div className="card-logo">
              <div className="logo-badge">
                {/* Only keeping the top blue graduation cap logo as requested */}
            ...
            <button type="submit" className="login-submit-btn" disabled={isLoading}>
              {isLoading ? (
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
                  ...
                  <span style={{ fontSize: "14px" }}>{loadingMsg}</span>
                </div>
              ) : (
                <>
